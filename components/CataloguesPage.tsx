        ...
        {visibleCatalogues.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {visibleCatalogues.map((catalogue) => (
              ...
              >
                <div className="aspect-w-3 aspect-h-4 rounded-lg overflow-hidden bg-gray-100 shadow-lg">
                  <img 
                ...
                <div className="mt-4 text-center">
                  <h2 className="text-lg font-bold text-gray-900 group-hover:text-[#5a1e38]">{catalogue.title}</h2>
                  <p className="mt-2 text-sm text-gray-600 line-clamp-2">{catalogue.description}</p>
