...
import { SALA_SUB_CATEGORIES } from '../constants';
...
const SalaMegaMenu: React.FC<SalaMegaMenuProps> = ({ onSelectCategory, onClose }) => {
    ...
    <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-4 gap-6 py-5">
        <div className="col-span-3 grid grid-cols-6 gap-x-4 gap-y-3">
          {SALA_SUB_CATEGORIES.map((category) => (
        ...
        <div className="col-span-1 relative rounded-md overflow-hidden group h-full">
          ...
          <a href="#" onClick={handleClick} className="absolute inset-0" aria-label="Ver todos los muebles de sala"></a>
        </div>
      </div>
    </div>
  );
